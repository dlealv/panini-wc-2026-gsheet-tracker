# Step-by-Step Guide to Accessing the Template and Apps Script

This document provides a comprehensive guide on the main steps to follow to create a copy of the file and begin working with it.
...
![Make a Copy](images/google%20access/allowAccessBanner.jpg)
...
![Make a Copy](images/google%20access/unverifiedGoogleMessage.jpg)
...
This message is normal, even for the first time. The owner of the file, when attempting to execute a service from the **Manage Panini** menu, will receive the same message. To fully experience the template, click on the Advanced link.

![Make a Copy](images/google%20access/unverifiedGoogleMessageAfterClick.jpg)
...
![Make a Copy](images/google%20access/accessRequestForm.jpg)
