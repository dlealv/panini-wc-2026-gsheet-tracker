// test/ImportService.unit.test.js
/**
...
/** ImportStickers (unit) */
describe('ImportStickers (unit)', () => {
  let parser

  /* Each test starts with a fresh instance of ImportStickers and cleared mocks to ensure
...
describe('LineNormalizer (unit)', () => {
  ...
  describe('normalizeLine()', () => {
    ...
    test('semicolon delimiter in Format 2 is normalized to comma and parsed correctly', () => {
      const result = normalize.normalizeLine('BRA-1;BRA-2;BRA-3')
      expect(result.line).toBe('BRA,1,2,3')
    })
    test('colon delimiter in Format 1 is normalized to comma and parsed correctly', () => {
      const result = normalize.normalizeLine('BRA:1,2,3')
      expect(result.line).toBe('BRA,1,2,3')
    })
    test('space delimiter in Format 1 is normalized to comma and parsed correctly', () => {
      const result = normalize.normalizeLine('BRA 1 2 3')
      expect(result.line).toBe('BRA,1,2,3')
    })
    test('mix of space delimiter and colon in Format 1 is normalized to comma and parsed correctly', () => {
      const result = normalize.normalizeLine('BRA 1:2:3')
      expect(result.line).toBe('BRA,1,2,3')
    })
